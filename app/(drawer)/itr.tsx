        ...
        try{
            ...
            if(user != undefined){
                ...
                if(typeof(podData) != 'undefined'){
                        ...
                        const json1 = podData.data.response.lcJson;
                        var sJson = JSON.stringify(json1);
                        sJson = sJson.replace(/"tt-/g, '"tt');
                        var Jindex = sJson.indexOf("ProDataSet");
                        if (Jindex > -1) {
                            sJson = sJson.replace('{"','');
                            sJson = sJson + '\\"\\"}"';
                        }

                    let dataIn: IItem[] = JSON.parse(sJson);
                    console.log(dataIn);
                    let updatedList: any[] = [];
        ...
        <ScrollView horizontal={true} >      
            <View>
                <View style={styles.header}>
                    <Text style={[styles.headerText] }>ITR No.</Text>
